...
export async function answerSalesQuestionWithAI({
  ...
  const groundingBundle = buildGroundingBundle({ question, sessionContext, semanticRetrieval });
  ...
  return {
    ...
    retrieval_strategy: groundingBundle.retrieval_document_matches.strategy ?? "exact_record",
    vectorize_status: groundingBundle.retrieval_document_matches.vectorize_status ?? "not_needed",
